    ...
    <Layout>
      <section className="min-h-screen bg-gray-100 py-16">
        ...
        <div className="container mx-auto mt-10 text-center">
          ...
          <p className="text-lg mt-2">Chave PIX: 05.509.404/0001-29</p>
          <div className="mt-4">
          </div>
        </div>
        ...
        <div className="container mx-auto mt-10 px-4">
          <div className="flex flex-col md:flex-row justify-around items-center">
            ...
            >
              ...
              <p>Contribua com doações financeiras para ajudar em nossos projetos e iniciativas.</p>
            </motion.div>
            ...
            >
              <FaHandsHelping className="w-16 h-16 mx-auto text-[#89b72d] mb-4" />
              <h3 className="text-xl font-bold">Voluntariado</h3>
              <p>Junte-se a nós como voluntário e faça a diferença em nossa comunidade.</p>
            </motion.div>
            ...
            >
              <FaGift className="w-16 h-16 mx-auto text-[#89b72d] mb-4" />
              <h3 className="text-xl font-bold">Doações de Materiais</h3>
              <p>Doe roupas, alimentos e outros materiais que podem beneficiar aqueles que precisam.</p>
            </motion.div>
          </div>
        </div>
      </section>
